...
## Use instead of p.GUI for headless mode
#p.connect(p.DIRECT)

p.setRealTimeSimulation(0)
boundaryUid = p.createCollisionShape(p.GEOM_MESH, fileName='out_new.obj', meshScale=[1, 1, 1], flags=p.GEOM_FORCE_CONCAVE_TRIMESH)
