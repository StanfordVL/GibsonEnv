...
# RealEnv-related abstractions

class RealEnv(object):
    """The main real env class. It encapsulates an environment with
    ...
    def __new__(cls, *args, **kwargs):
        ...
        env = super(RealEnv, cls).__new__(cls)
