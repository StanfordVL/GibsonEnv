...
class CompletionNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.convs = nn.Sequential(
            ...
            nn.BatchNorm2d(128, momentum=alpha),
            nn.ReLU(),
            nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 1),
            nn.BatchNorm2d(128, momentum=alpha),
            nn.ReLU(),
            nn.Conv2d(128, 256, kernel_size = 3, stride = 2, padding = 1),
            nn.BatchNorm2d(256, momentum=alpha),
            nn.ReLU(),
            ...
            nn.BatchNorm2d(64, momentum=alpha),
            nn.ReLU(),
            nn.Conv2d(64, 32, kernel_size = 3, stride = 1, padding = 1),
            nn.BatchNorm2d(32, momentum=alpha),
            nn.ReLU(),
...
class Discriminator(nn.Module):
    ...
    def __init__(self, pano = False):
        ...
        self.convs_local = nn.Sequential(
            ...
            nn.BatchNorm2d(512, momentum=alpha),
            nn.ReLU(),
