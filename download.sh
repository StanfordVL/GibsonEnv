...
if [ `basename "$PWD"` = GibsonEnv ]; then
    ...
    wget https://storage.googleapis.com/gibson_scenes/assets_core_v2.tar.gz -O /tmp/gibson/assets_core_v2.tar.gz
    wget https://storage.googleapis.com/gibson_scenes/dataset.tar.gz -O /tmp/gibson/dataset.tar.gz
