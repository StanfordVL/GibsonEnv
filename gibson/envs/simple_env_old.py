...
, self.tracking_camera['pitch'],pos)
        ...
        #self.inspect_downsample2_points_and_dir()
        #self.plot_downsample2_points()

    def get_obj_range(self):
        datapath = "/ssd_local/gibson_data/test_model"
        model = 'sRj553CTHiw'
        input_file  = os.path.join(datapath, model, 'modeldata/out_z_up.obj')
        camera_pose_file = os.path.join(datapath, model, 'modeldata/sweep_locations.csv')
